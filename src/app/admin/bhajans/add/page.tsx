...
export default function AddBhajan() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Map textareas to arrays by splitting newlines
            ...
            if (response.ok) {
                ...
                alert(result.message || 'Failed to add bhajan');
            }
        } catch (error) {
            console.error('Error adding bhajan:', error);
            alert('Failed to add bhajan. Please try again.');
        } finally {
            ...
            <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl font-bold text-gray-800">Add New Bhajan</h1>
                    </div>
                </div>
            </header>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="flex justify-end gap-4 pt-6 border-t border-gray-100">
                            ...
                            >
                                {isSubmitting ? 'Saving...' : <><FaSave /> Save Bhajan</>}
                            </button>
                        </div>
